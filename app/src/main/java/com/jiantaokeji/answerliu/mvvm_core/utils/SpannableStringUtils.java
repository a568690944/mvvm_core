...
//                if (imageIsBitmap) {
//                    mBuilder.setSpan(new ImageSpan(App.getAppContext(), bitmap), start, end, flag);
//                    bitmap = null;
//                    imageIsBitmap = false;
...
//                } else if (imageIsUri) {
//                    mBuilder.setSpan(new ImageSpan(App.getAppContext(), uri), start, end, flag);
//                    uri = null;
//                    imageIsUri = false;
//                } else {
//                    mBuilder.setSpan(new ImageSpan(App.getAppContext(), resourceId), start, end, flag);
//                    resourceId = 0;
